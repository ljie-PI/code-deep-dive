...
```
Line 12: profileCheckpoint('main_tsx_entry')
Line 17: startMdmRawRead()          // 启动 plutil/reg query 子进程
Line 25: startKeychainPrefetch()    // 并行读取 macOS keychain
...
Line 451: profileCheckpoint('main_tsx_imports_loaded')
```
